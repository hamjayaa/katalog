...
// - imageUrl: GANTI DENGAN LINK CLOUDINARY ANDA
...
// Perhatikan: img: GANTI DENGAN LINK CLOUDINARY ANDA
...
const stackingProductsData = [
    ...
    { 
        ...
        img: 'https://res.cloudinary.com/demo/image/upload/v1625123456/placeholder_landscape.jpg' // <-- GANTI DENGAN LINK CLOUDINARY KAMU
    },
    // SLIDE 2: PASTA GIGI
    { 
...
function createHorizontalCardHTML(data, index) {
    ...
    // Sekarang menggunakan 'data.imageUrl' bukan 'data.imgText'
    return `
        <div class="flex-shrink-0 w-[80vw] sm:w-[50vw] lg:w-[40vw] xl:w-[30vw] h-[60vh] snap-center cursor-pointer" 
            ...
            <div class="bg-clean-card rounded-3xl p-6 md:p-8 product-card-detail shadow-xl transition-all duration-300 hover:scale-[1.01] hover:shadow-clean-text/10 border border-clean-subtext/10" id="card-detail-${index}">
                <div class="product-card-image" style="background-image: url('${data.imageUrl}'); background-size: cover; background-position: center;"></div>
...
// ... Sisa kode JavaScript (fungsi-fungsi animasi) tetap sama, tidak perlu diubah ...
// (Saya potong di sini agar tidak terlalu panjang, cukup copy-paste bagian di atas saja
// karena bagian bawahnya tidak ada perubahan)
